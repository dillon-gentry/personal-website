          ...
          <div className="foot-flex-col">
            <div className="foot-flex-col-icon-row">
              <div className="foot-flex-col-icon-row-item">
                <span class="fa-stack">
                  <a
                    href="mailto: djg81999@gmail.com"
                ...
                <span class="fa-stack">
                  <a
                    className="foot-logo-link"
                    href="https://www.linkedin.com/in/dillon-gentry-768b411a0/"
                  >
                    <i class="fa-stack-1x fa fa-square"></i>
            ...
            <div className="foot-flex-col-text-col">
              <p className="foot-text">Last updated: 8/27/2021</p>
              <p className="foot-text">
                Made with ReactJS, React-PDF, HTML, CSS, ScreenToGif, and
                FontAwesome.
              </p>
              <p className="foot-text-hide">Last updated: 8/27/2021</p>
              <p className="foot-text-hide">
                Made with ReactJS, React-PDF, HTML, CSS, ScreenToGif, and
                FontAwesome.
              </p>
            </div>
